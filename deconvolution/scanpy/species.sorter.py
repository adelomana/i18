...
print(len(cellIDs),len(labels),labels[0])
print('mouse',len(mouseCellIDs),mouseCellIDs[0])
print('human',len(humanCellIDs),humanCellIDs[0])
print('chimeric',len(chimericCellIDs),chimericCellIDs[0])
